    ...
    function() {
        fabric.PencilBrush = fabric.util.createClass(fabric.BaseBrush, {
            ...
            onMouseDown: function(e) {
                /*************************************/
                isDown = true;
                context_length = Object.keys(data_list).length;
                temp = {}
                temp['contextTop'] = this.canvas.contextTop;
                temp['viewportTransform'] = this.canvas.viewportTransform;
                temp['_points'] = [];
                data_list[context_length] = temp;
                /*************************************/
            ...
            _addPoint: function(e) {
                data_list[context_length]._points.push(e);
                this._points.push(e);
            },
            _reset: function() {
